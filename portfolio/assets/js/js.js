...
// console.log(menu_show_btn);
// console.log(menu_hide_btn);
...
function navHighlighter() {
  ...
  /*
- if our current scroll postion enters the space where current section on screen is , add-
- to know which link nneed an active class we use sectionId variable we are getting while
*/
  ...
  sections.forEach((current) => {
    ...
    //   let myn = document.querySelector(".nav__menu a[href*="+ sectionId + "]")
...
sr.reveal(`.sr06`, { delay: 300, origin: "top" }),
  ...
  sr.reveal(`.sr010`, { delay: 1500, origin: "top" });
